...
console.log(element);
  return (
    <Paper
      ...
      className="kkkkk"
    >{
      controls?<div style={{display:"flex",justifyContent:"space-evenly",flexDirection:"column"}}>
      <div>
...
VerticalColumn.craft = {
  ...
  related: {
    settings: VerticalColumnSettings,
  },
};
